...
|   |  | Desc|  Download|
| :---: | :--- | :--- | :--- |
| <img src="https://github.com/kiprutobeauttah/faced/blob/main/faceD/assets/logo-only.png?raw=true" width="120" alt="Facion"/> | **FaceD** | Face matching | [**debian**](https://github.com/kiprutobeauttah/faced/releases/download/Algo/faced-1.0.0-Linux.deb) |
|![img](https://github.com/kiprutobeauttah/tetrus/blob/main/packaging/tetrus.png) | **tetrus** | exploring Game dev | [**debian**](https://github.com/kiprutobeauttah/tetrus/releases/download/tetrus/tetrus-1.0.0-Linux.deb) |
